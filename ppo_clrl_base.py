...
if __name__ == "__main__":
    ...
    for update in range(1, num_updates + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            if global_step % args.eval_freq == 0:
                eval_return_test, eval_length_test = evaluata_policy_test(envs, agent, evaluate_env, args.gamma, args.seed)
                eval_return_train, eval_length_train = evaluata_policy_train(envs, agent, envs, args.gamma, args.seed)
    ...
    torch.save(agent, f"./model/{args.env_id}__{args.exp_name}__{args.seed}__{int(time.time())}")
