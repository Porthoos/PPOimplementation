...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_train_steps", type=int, default=int(3e7), help=" Maximum number of training steps")
    ...
    env_name = ['BipedalWalker-v3', 'HalfCheetah-v2', 'Hopper-v2', 'Walker2d-v2', 'CartPole-v0', 'gym_STAR/My_Env-v1']
    env_index = 5
